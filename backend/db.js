...
db.exec(`
  CREATE TABLE IF NOT EXISTS users (id TEXT PRIMARY KEY, email TEXT UNIQUE, password TEXT, name TEXT, role TEXT, created_at DATETIME DEFAULT CURRENT_TIMESTAMP, subscription_status TEXT DEFAULT 'inactive');
  ...
  CREATE TABLE IF NOT EXISTS sessions (id TEXT PRIMARY KEY, course_id TEXT, title TEXT, room_id TEXT, start_time DATETIME, created_by TEXT);
